...
public class SubjectController {
    ...
    @GetMapping("/get-by-code/{subjectCode}")
    ...
    @GetMapping("/get-by-type/{subjectType}")
    ...
    @GetMapping("/get-by-grade/{gradeLevel}")
    ...
    @PatchMapping("/update-teacher/{subjectId}")
    ...
    @PatchMapping("/update-order/{subjectId}")
    ...
    @GetMapping("/check-code-exists/{subjectCode}")
