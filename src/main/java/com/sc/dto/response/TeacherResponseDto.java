...
public class TeacherResponseDto {
    ...
    // Experience entries
    private List<ExperienceResponse> previousExperience = new ArrayList<>();
    ...
    private Double da;
    private Double ta;
    private List<AllowanceResponse> additionalAllowances = new ArrayList<>();
    ...
    // Stats
    private Integer assignedClassCount;
    ...
    public static class AllowanceResponse {
        private String name;
    ...
    public List<ExperienceResponse> getPreviousExperience() { return previousExperience; }
    public void setPreviousExperience(List<ExperienceResponse> previousExperience) {
        this.previousExperience = previousExperience != null ? previousExperience : new ArrayList<>();
    }

    public List<QualificationResponse> getQualifications() { return qualifications; }
    ...
    public List<AllowanceResponse> getAdditionalAllowances() { return additionalAllowances; }
    public void setAdditionalAllowances(List<AllowanceResponse> additionalAllowances) {
    ...
    public Integer getAssignedClassCount() { return assignedClassCount; }
    public void setAssignedClassCount(Integer assignedClassCount) { this.assignedClassCount = assignedClassCount; }
