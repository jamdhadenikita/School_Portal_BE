...
public class TeachersSalaryEntity {
    ...
    private java.util.List<TeachersAttendanceEntity> attendanceRecords;
    ...
    public java.util.List<TeachersAttendanceEntity> getAttendanceRecords() {
        return attendanceRecords;
    }

    public void setAttendanceRecords(java.util.List<TeachersAttendanceEntity> attendanceRecords) {
