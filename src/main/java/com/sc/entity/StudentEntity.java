...
public class StudentEntity {
    ...
    @OneToMany(
            mappedBy = "student",           // ✅ Bi-directional mapping
            cascade = CascadeType.ALL,      // ✅ Save/Update/Delete cascades
            fetch = FetchType.LAZY,         // ✅ Lazy loading for performance
            orphanRemoval = true            // ✅ Remove orphaned fees records
    )
